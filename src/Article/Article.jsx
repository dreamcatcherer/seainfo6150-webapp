...
const Article = () => {
  return (
    ...
    <div>
      ...
      <div><i>by Kate Farley</i> (<a href = "mailto:kate.farley@nytimes.com">kate.farley@nytimes.com</a>)</div>
      ...
      <ul>
         ...
         <li>Total weight of the Statue of Liberty is <b>225 tons</b> (<b>or 450,000 pounds</b>)</li>
      </ul>
      </article>
      </div>
